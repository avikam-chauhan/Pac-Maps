...
class TutorialDisplayViewController: UIViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    let dataSource = ["Welcome To TrailPlay!", "Long Press to Add Waypoints", "Shake to Remove", "Compete with Friends", "Stay Away from Others", "Add Family Members", "Swipe Down to Play!"]
